...
## Building
bamtofastq is a standard Rust executable project that works with stable Rust >=1.30.  Install Rust through the standard channels, then type `cargo build --release`.
